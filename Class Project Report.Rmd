...
min_DBH_baseR <- min(AltoonaTrees$DBH, na.rm = TRUE)
print(min_DBH_baseR)

max_DBH_baseR <- max(AltoonaTrees$DBH, na.rm = TRUE)
print(max_DBH_baseR)
...
mean_DBH_Portland <- 
  pdxTrees_parks %>%
  summarize(mean_column = mean(DBH, na.rm = TRUE))
print(mean_DBH_Portland)

mean_height_Portland <-
  pdxTrees_parks %>%
  summarize(mean_column = mean(Tree_Height, na.rm = TRUE))
print(mean_height_Portland)
```
